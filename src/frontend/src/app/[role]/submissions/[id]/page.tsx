...
interface SubmissionDetail {
  ...
  reviews: Array<{
    ...
    max_score: string;
    feedback: string;
    reviewer: { id: string; email: string; first_name: string; last_name: string };
    reviewed_at: string;
  }>;
}
...
export default function SubmissionDetailPage() {
  ...
  const loadSubmission = async () => {
    ...
    try {
      ...
      // Установить начальный балл из max_score
      if (data.assignment?.max_score) {
        setReviewScore(Number(data.assignment.max_score));
      }
    } catch (err) {
  ...
  const handleReview = async () => {
    ...
    try {
      ...
      setSuccess('✅ Riev muvaffaqiyatli saqlandi!');
      setReviewFeedback('');
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-3xl mx-auto px-4 py-16 text-center">
          ...
          <Link href={basePath} className="text-primary hover:text-primary/80 font-body">
              ...
              <div key={revision.id} className="border border-border rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    {revision.payload?.github_url && (
                      <div>
                        ...
                        <a href={revision.payload.github_url} target="_blank" rel="noopener noreferrer"
                ...
                {revision.submission_type === 'external_link' && revision.payload?.url && (
                  <div>
                    ...
                    <a href={revision.payload.url} target="_blank" rel="noopener noreferrer"
                      className="text-primary hover:text-primary/80 font-body break-all">
          ...
          <div className="space-y-4">
            <div>
              ...
              >
                ...
                <option value="changes_requested">🔄 O'zgartirishlar so'rash</option>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Talaba uchun fikr yoki izoh..."
              />
            </div>
            ...
            >
              {submitting ? 'Yuborilmoqda...' : '📤 Rievni yuborish'}
            </button>
          </div>
        </div>
      </div>
